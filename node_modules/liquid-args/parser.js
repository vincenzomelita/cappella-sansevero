...
function peg$parse(input, options) {
  ...
  var peg$startRuleFunctions = { Args: peg$parseArgs };
  var peg$startRuleFunction = peg$parseArgs;
  ...
  var peg$e2 = peg$classExpectation([["A", "z"], ["0", "9"], "_", "-"], false, false);
  ...
  var peg$f0 = function(a, args) { return [a].concat(args) };
  ...
  var peg$f5 = function() { return evaluate(text()); };
  var peg$f6 = function() { return text() };
  var peg$f7 = function(whitespace) {
